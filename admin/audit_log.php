...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav-list">
        ...
        <li><a href="<?= mlgu_url_attr('audit_log.php') ?>" class="sidebar-link active"><i class="fas fa-list-check"></i><span>Audit Log</span></a></li>
...
<main class="main-content">
    ...
    <form method="get" class="filters" id="filtersForm">
        ...
        <?php if ($filterSystem !== '' || $filterAction !== '' || $filterFrom !== '' || $filterTo !== ''): ?>
            <a href="<?= mlgu_url_attr('audit_log.php') ?>" class="clear-link">Clear</a>
        <?php endif; ?>
    </form>
