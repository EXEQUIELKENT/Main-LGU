...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ' . mlgu_url('security.php'));
    exit;
}
...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav-list">
        ...
        <li><a href="<?= mlgu_url_attr('security.php') ?>" class="sidebar-link active"><i class="fas fa-shield-halved"></i><span>Security</span></a></li>
    </ul>
