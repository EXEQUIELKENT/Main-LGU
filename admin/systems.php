...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ' . mlgu_url('systems.php'));
    exit;
}
...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav-list">
        ...
        <li><a href="<?= mlgu_url_attr('systems.php') ?>" class="sidebar-link active"><i class="fas fa-server"></i><span>Connected Systems</span></a></li>
