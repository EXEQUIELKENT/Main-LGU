...
('urbanplanning', 'Urban Planning & Development', 'http://localhost/lgu-urban-planning-capstone/lgu-urban-planning', '/admin/index.php', '/sso_consume.php', '/api/stats.php', 'e935e6cd6041b49b2c8aaa3a04fd7370e2266974799c0a8a250845f9e5d3ec97', 1, 'fa-map', 'amber', 'UPAD')
